...
/**
 * OAuth verification code receiver that runs a Jetty server on a free port, waiting for a
 ...
 * @author Yaniv Inbar
 */
public final class LocalServiceReceiver implements VerificationCodeReceiver {
     ...
     */
    LocalServiceReceiver(String host, int port) {
        this.host = host;
        this.port = port;
    }
    ...
    public static final class Builder {
        ...
        public LocalServiceReceiver build() {
            return new LocalServiceReceiver(host, port);
        }
